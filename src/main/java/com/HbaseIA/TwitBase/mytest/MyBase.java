...
public class MyBase {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            try {
                Put put = new Put(Bytes.toBytes("TheRealMT")); // TheRealMT is rowkey
                ...
                // }
                // passwd = CellUtil.cloneValue(passwords.get(0));
                // String currentPassword = Bytes.toString(passwd);
                // System.out.println("currentPassword: " + currentPassword);
                // passwd = CellUtil.cloneValue(passwords.get(1));
                // System.out.println("oldPassword: " + Arrays.toString(passwd));


                // 删除数据
                // Delete delete = new Delete(Bytes.toBytes("TheRealMT")); // 指定删除的row
                // delete.addColumn(Bytes.toBytes("info"), Bytes.toBytes("password"));  // 指定删除的col
